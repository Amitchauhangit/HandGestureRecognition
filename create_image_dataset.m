...
Files=dir('dataset/*/*.jpg'); % struct array containing name ,folder, date, bytes, isdir, datenum
for k=1:length(Files)
    ...
    % [1 0 0 0] - left folder;  [0 1 0 0] - right folder; [0 0 1 0] - palm folder;
    % [0 0 0 1] - peace folder;
    ...
    % Returns 50x50 image
    image_out = SkinImage(fileLocation);
